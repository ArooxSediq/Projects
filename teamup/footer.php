...
<div id="footer">
  ...
  <div class="row justify-content-center" id="bottomNav">
    ...
    <div class="col-3 "><a class="btn btn-outline-light" href="matches/index.php"><img src="img/home.png"><text class="d-none d-md-block">Feed</text> </a></div>
    <div class="col-3 "><a class="btn btn-outline-light" href="matches/profile.php"><img src="img/profile.png"><text class="d-none d-md-block">My games</text></a></div>
    <div class="col-3"><a class="btn btn-outline-light" href="matches/create.php"><img src="img/create.png"><text class="d-none d-md-block">Create</text></a></div>
      <?php 
